...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class STUDENTTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""SYS"".""STUDENT"" WHERE ((""S_ID"" = :Original_S_ID) AND (""NAME"" = :Origi"& _ 
                "nal_NAME) AND (""COURSE_ID"" = :Original_COURSE_ID) AND ((:IsNull_RANK = 1 AND ""RA"& _ 
                "NK"" IS NULL) OR (""RANK"" = :Original_RANK)) AND ((:IsNull_CATEGORY = 1 AND ""CATEG"& _ 
                "ORY"" IS NULL) OR (""CATEGORY"" = :Original_CATEGORY)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SYS"".""STUDENT"" (""S_ID"", ""NAME"", ""COURSE_ID"", ""RANK"", ""CATEGORY"") VAL"& _ 
                "UES (:S_ID, :NAME, :COURSE_ID, :RANK, :CATEGORY)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""SYS"".""STUDENT"" SET ""S_ID"" = :S_ID, ""NAME"" = :NAME, ""COURSE_ID"" = :COURSE_"& _ 
                "ID, ""RANK"" = :RANK, ""CATEGORY"" = :CATEGORY WHERE ((""S_ID"" = :Original_S_ID) AND "& _ 
                "(""NAME"" = :Original_NAME) AND (""COURSE_ID"" = :Original_COURSE_ID) AND ((:IsNull_"& _ 
                "RANK = 1 AND ""RANK"" IS NULL) OR (""RANK"" = :Original_RANK)) AND ((:IsNull_CATEGOR"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.University_Counselling_Form.My.MySettings.Default.ConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT S_ID, ""NAME"", COURSE_ID, RANK, CATEGORY FROM SYS.STUDENT"
    ...
    Partial Public Class ADDRESSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SYS"".""ADDRESS"" (""S_ID"", ""VILLAGE"", ""PO"", ""PS"", ""ZIPCODE"", ""STATE"", """& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT S_ID, VILLAGE, PO, PS, ZIPCODE, STATE, DISTRICT FROM SYS.ADDRESS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class PAYMENT_DETAILSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SYS"".""PAYMENT_DETAILS"" (""S_ID"", ""T_ID"", ""PAY_DATE"", ""AMOUNT"", ""MOP"")"& _ 
                " VALUES (:S_ID, :T_ID, :PAY_DATE, :AMOUNT, :MOP)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.Oracle.ManagedDataAccess.Client.OracleParameter = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "S_ID"
            param.OracleDbTypeEx = Global.Oracle.ManagedDataAccess.Client.OracleDbType.Varchar2
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT S_ID, T_ID, PAY_DATE, AMOUNT, MOP FROM SYS.PAYMENT_DETAILS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class PERSONAL_DETAILSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SYS"".""PERSONAL_DETAILS"" (""S_ID"", ""FATHER_NAME"", ""MOTHER_NAME"", ""MOBI"& _ 
                "LE"", ""EMAIL"", ""DOB"") VALUES (:S_ID, :FATHER_NAME, :MOTHER_NAME, :MOBILE, :EMAIL,"& _ 
                " :DOB)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.Oracle.ManagedDataAccess.Client.OracleParameter = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "S_ID"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT S_ID, FATHER_NAME, MOTHER_NAME, MOBILE, EMAIL, DOB FROM SYS.PERSONAL_DETAI"& _ 
                "LS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class RANKTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SYS"".""RANK"" (""S_ID"", ""COURSE_ID"", ""GEN_RANK"", ""RESERVE_RANK"", ""MARKS"& _ 
                "_SECURE"") VALUES (:S_ID, :COURSE_ID, :GEN_RANK, :RESERVE_RANK, :MARKS_SECURE)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.Oracle.ManagedDataAccess.Client.OracleParameter = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "S_ID"
            param.OracleDbTypeEx = Global.Oracle.ManagedDataAccess.Client.OracleDbType.Varchar2
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT S_ID, COURSE_ID, GEN_RANK, RESERVE_RANK, MARKS_SECURE FROM SYS.RANK"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class ADMISSIONTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""SYS"".""ADMISSION"" WHERE ((""ENROL_NO"" = :Original_ENROL_NO) AND (""S_ID"& _ 
                """ = :Original_S_ID) AND (""CENTER_ID"" = :Original_CENTER_ID) AND (""COURSE_ID"" = :"& _ 
            ...
            Me._adapter.InsertCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SYS"".""ADMISSION"" (""ENROL_NO"", ""S_ID"", ""CENTER_ID"", ""COURSE_ID"", ""DOA"& _ 
                """, ""MOP"") VALUES (:ENROL_NO, :S_ID, :CENTER_ID, :COURSE_ID, :DOA, :MOP)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            ...
            Me._adapter.UpdateCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""SYS"".""ADMISSION"" SET ""ENROL_NO"" = :ENROL_NO, ""S_ID"" = :S_ID, ""CENTER_ID"" "& _ 
                "= :CENTER_ID, ""COURSE_ID"" = :COURSE_ID, ""DOA"" = :DOA, ""MOP"" = :MOP WHERE ((""ENRO"& _ 
                "L_NO"" = :Original_ENROL_NO) AND (""S_ID"" = :Original_S_ID) AND (""CENTER_ID"" = :Or"& _ 
                "iginal_CENTER_ID) AND (""COURSE_ID"" = :Original_COURSE_ID) AND (""DOA"" = :Original"& _ 
                "_DOA) AND (""MOP"" = :Original_MOP))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
            param.ParameterName = "ENROL_NO"
            param.DbType = Global.System.Data.DbType.Int32
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT ENROL_NO, S_ID, CENTER_ID, COURSE_ID, DOA, MOP FROM SYS.ADMISSION"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class LOGINTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SYS"".""LOGIN"" (""USERNAME"", ""PASSWORD"") VALUES (:USERNAME, :PASSWORD)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.Oracle.ManagedDataAccess.Client.OracleParameter = New Global.Oracle.ManagedDataAccess.Client.OracleParameter()
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.Oracle.ManagedDataAccess.Client.OracleCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT USERNAME, PASSWORD FROM SYS.LOGIN"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
